...
export async function fetchAllFeesInfoTest() {
  try {
...
// FeesHelper.js
export async function saveFeesInfoSettings(feesInfoSetting) {
  try {
    const payload = {
      autoFetch: feesInfoSetting.autoFetchOn, // rename key to match backend!
      autoFetchTime: feesInfoSetting.targetTime, // rename key to match backend!
    };

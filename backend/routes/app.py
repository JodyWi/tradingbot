...
@app_routes.get("/api/app/settings/getmarketinfo")
def app_getmarket_settings():
    return jsonify(get_marketsinfo_settings())


@app_routes.post("/api/app/settings/savemarketinfo")
...
@app_routes.get("/api/app/settings/gettradeinfo")
def app_gettrade_settings():
    return jsonify(get_tradesinfo_settings())


@app_routes.post("/api/app/settings/savetradeinfo")
...
@app_routes.get("/api/app/settings")

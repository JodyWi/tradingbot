...
backend_dir = os.path.expanduser("~/myproject/tradingbot/Backend")
frontend_dir = os.path.expanduser("~/myproject/tradingbot/Frontend")
venv_python = os.path.expanduser("~/myproject/tradingbot/venv/bin/python")
